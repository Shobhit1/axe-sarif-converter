...
/**
 * Static Analysis Results Format (SARIF) Version 2.1.0-beta.0 JSON Schema: a standard format for the output of static analysis tools.
 */
export interface StaticAnalysisResultsFormatSARIFVersion210Beta0JSONSchema {
    /**
...
export interface Run {
    ...
    externalPropertyFileReferences?: {
         ...
         */
        requests?: ExternalPropertyFileReference[];
        /**
         * An array of external property files containing run.responses arrays to be merged with the root log file.
         */
        responses?: ExternalPropertyFileReference[];
        /**
